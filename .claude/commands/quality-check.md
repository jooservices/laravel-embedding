---
description: Review a change for lints, static analysis, and coverage expectations
argument-hint: [scope]
---
...
Review or implement for scope: $ARGUMENTS

Identify likely failures in Pint, PHPCS, PHPStan, PHPMD, PHP-CS-Fixer, tests, and the 90% coverage gate.
